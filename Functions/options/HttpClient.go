...
func Client(method string, url string, body io.Reader, Headers map[string]string, timeout time.Duration, redirects string, timeout_count map[string]int, paras params) (resp *http.Response) {
...
func UClient(method, url string, filestruct Configs.FileNameStruct, body io.Reader, Headers map[string]string, timeout time.Duration, redirects string, timeout_count map[string]int, paras params) (resp *http.Response) {
	...
	if err2 != nil {
		MistakPrint("Can't Open " + filestruct.FilePath + "file")
		return
	}
	defer file.Close()
	...
	if err != nil {
		...
		MistakPrint("form-Config;name=" + filestruct.Name + ";filename=" + filestruct.Filename)
		return
	}
